            ...
            <div class="div-img" onmouseover="mouseOverImg(this)">
                <div >
                    <span  onclick="javascript:;" class="span-left">
                        <input class="icheck" style=" margin-left: 3px; margin-top: 5px;" type="checkbox"/>
                    </span>
                        <span onclick="javascript:removeImg(this);" class="span-right">
                        <li class="fa fa-remove span-li"></li>
                    </span>
                        <img src="http://shipinfo.oss-cn-shanghai.aliyuncs.com/goshipyard/GWTcR228ek.jpg" style="width: 150px;height: 150px;"/>
                </div>
