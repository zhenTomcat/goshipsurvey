...
<div class="modal-dialog">
    <div class="modal-content">
        ...
        <div class="modal-header" style="background-color: #32c5d2;">
            ...
            <h4 class="modal-title" style="color: white">Surveyor Info</h4>
        </div>
        <div class="row">
            <div class="col-md-12">
                                    ...
                                    <div class="tab-content">
                                        <div class="tab-pane active">
                                            <form id="add-surveyor-form" action="surveyor/editComplete" method="post">
                                                ...
                                                <input name="pastEvaluation" value="${surveyor.pastEvaluation}"
                                                       type="hidden">
                                                    ...
                                                    <div class="mt-checkbox-inline">
                                                        <c:forEach items="${surveyType}" var="type">
                                                            <label class="mt-checkbox col-sm-5">
                                                                <input type="checkbox" value="${type.value}"
                                                                       name="surveyType"
                                                                <c:forEach items="${userSurveyTypes}"
                                                                           var="userSurveyType">
                                                ...
                                                <div class="form-group col-md-12">
                                                    ...
                                                    <button id="add-row-btn" type="button" class="btn btn-sm green"
                                                            style="padding: 2px 5px" onclick="TableDeal.addRow()">+ Add
                                                        new
                                                    </button>
                                                        ...
                                                        <c:forEach items="${experienceList}" var="e">
                                                            <tr>
                                                                ...
                                                                <td><input value="${e.workContent}" type="text"
                                                                           class=" form-control"></td>
                                                                <td>
                                                                    <button onclick="TableDeal.deleteRow(this)"
                                                                            type="button"
                                                ...
                                                <div class="margin-top-10 margin-bottom-10 col-md-12">
                                                    <button type="button" onclick="editSurveyor(this)"
