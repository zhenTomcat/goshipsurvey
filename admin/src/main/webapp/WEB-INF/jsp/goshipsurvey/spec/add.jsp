...
<form class="form-horizontal" action="spec/add" method="post" id="spec-add-form">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <div class="col-sm-6">
                                    <input id="inspectType" name="inspectType" type="text"
                                           class="form-control required">
                                </div>
                            </div>
                            <div class="form-group col-md-12">
                                ...
                                <div class="col-sm-6">
                                    <input id="inspectPort" name="inspectPort" type="text"
                                           class="form-control required">
                                </div>
                            </div>
                            <div class="form-group col-md-12">
                                ...
                                <div class="col-sm-6 date-picker input-daterange" >
                                    <input id="inspectDate" name="inspectDate" type="text"
                                           class="form-control required">
                                </div>
                            </div>
                            <div class="form-group col-md-12">
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <div class="col-sm-1">
                                    <input id="surveyorAName" name="surveyorAName" type="text"
                                           class="form-control required">
                                </div>
                            ...
                            <div class="form-group col-md-12">
                                <label class="col-sm-4 control-label required-label">验船师名称</label>
                                <div class="col-sm-1">
                                    <input id="surveyorBName" name="surveyorBName" type="text"
                                           class="form-control required">
                                </div>
