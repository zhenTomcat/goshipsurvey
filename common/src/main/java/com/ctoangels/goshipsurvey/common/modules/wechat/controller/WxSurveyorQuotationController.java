...
public class WxSurveyorQuotationController extends BaseController {
    ...
    public JSONObject getQuotation(@RequestParam(required = true) Integer userId) {
        ...
        ew1.addFilter("inspection_status!={0} and surveyor_id={1}",Const.INSPECTION_END,userId);
        ...
        ew2.addFilter("inspection_status={0} and surveyor_id={1}",Const.INSPECTION_END,userId);
